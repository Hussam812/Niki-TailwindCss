...
const Footer = () => {
  return (
    <footer className="max-contaienr">
      <div className="flex justify-between items-start gap-20 flex-wrap max-1g:flex-col">
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justidy-start items-center gap-2 font-montserrat cursor-pointer ">
          <img
            src={copyrightSign}
            alt="copy right sign"
            width={20}
